...
CREATE TABLE `Problem_Discussion_Replies` (
  ...
  `is_anonymous` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Indica si la respuesta fue publicada de forma anónima',
...
CREATE TABLE `Problem_Discussions` (
  ...
  `is_anonymous` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Indica si la discusión fue publicada de forma anónima',
